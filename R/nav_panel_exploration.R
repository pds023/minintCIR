                               ...
                               nav_panel("Vue d'ensemble",icon = bs_icon("clipboard2-data"),value = "panel_exploration_vue_densemble",
                                         navset_card_underline(height = "600px",title = "Éléments descriptifs",
                                                               nav_panel(title = "Pays de nationalité",
                                                                         ...
                                                                         fluidRow(
                                                                           column(6,create_radio("highchart_stats_pays_type","type")),
                                                                           column(6,create_radio("highchart_stats_pays_pct","pct")))),
                                                               nav_panel(title = "Sexe",
                                                                         highchartOutput("highchart_stats_sexe"),
                                                                         fluidRow(
                                                                           column(6,create_radio("highchart_stats_sexe_type","type")),
                                                                           column(6,create_radio("highchart_stats_sexe_pct","pct")))),
                                                               nav_panel(title = "Tranche d'âge",
                                                                         highchartOutput("highchart_stats_age"),
                                                                         fluidRow(
                                                                           column(6,create_radio("highchart_stats_age_type","type")),
                                                                           column(6,create_radio("highchart_stats_age_pct","pct")))),
                                                               nav_panel(title = "Territoire",
                                                                         highchartOutput("highchart_stats_territoire"),
                                                                         fluidRow(
                                                                           column(6,create_radio("highchart_stats_territoire_type","type")),
                                                                           column(6,create_radio("highchart_stats_territoire_pct","pct")))),
                                                               nav_panel(title = "Motif",
                                                                         highchartOutput("highchart_stats_motif"),
                                                                         fluidRow(
                                                                           column(6,create_radio("highchart_stats_motif_type","type")),
                                                                           column(6,create_radio("highchart_stats_motif_pct","pct")))),
                                                               nav_panel(title = "Parcours",
                                                                         highchartOutput("highchart_stats_parcours"),
                                                                         fluidRow(
                                                                           column(6,create_radio("highchart_stats_parcours_type","type")),
                                                                           column(6,create_radio("highchart_stats_parcours_pct","pct")))))
                                         ),
                                           ...
                                           layout_sidebar(
                                             ...
                                             navset_card_underline(
                                                                   nav_panel(title = "Pays de nationalité",
                                                                             ...
                                                                             create_radio("highchart_compare_pays_pct","pct")),
                                                                   nav_panel(title = "Sexe",
                                                                             highchartOutput("highchart_compare_sexe"),
                                                                             create_radio("highchart_compare_sexe_pct","pct")),
                                                                   nav_panel(title = "Tranche d'âge",
                                                                             highchartOutput("highchart_compare_age"),
                                                                             create_radio("highchart_compare_age_pct","pct")),
                                                                   nav_panel(title = "Territoire",
                                                                             highchartOutput("highchart_compare_territoire"),
                                                                             create_radio("highchart_compare_territoire_pct","pct")),
                                                                   nav_panel(title = "Motif",
                                                                             highchartOutput("highchart_compare_motif"),
                                                                             create_radio("highchart_compare_motif_pct","pct")),
                                                                   nav_panel(title = "Parcours",
                                                                             highchartOutput("highchart_compare_parcours"),
                                                                             create_radio("highchart_compare_parcours_pct","pct")))
                                           )
                                         )),
